...
## Bài toán
Trong một hệ thống như AegisFlow AI hoặc E-commerce, khi có nhiều hơn 2 vai trò truy cập ứng dụng (ví dụ: `Admin`, `Operator`, `Citizen`, `AI Specialist`), nếu dùng chung một Frontend Layout và check roles bằng condition `if/else`, code sẽ phình to (Bloated Sidebar), dễ lộ logic ẩn và khó mở rộng theo chiều dọc.
